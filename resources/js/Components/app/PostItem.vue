    ...
    <div class="grid grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
      <template v-for="attachment of post.attachments">
        <div class="group aspect-square bg-indigo-50 text-gray-500 flex flex-col items-center justify-center relative">
          <button class="opacity-0 group-hover:opacity-100 transition-all absolute right-2 top-2 cursor-pointer bg-gray-600 hover:bg-gray-800 text-gray-100 flex items-center justify-center w-8 h-8 rounded">
