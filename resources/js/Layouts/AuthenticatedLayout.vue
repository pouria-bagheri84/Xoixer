    ...
    <nav class="bg-white border-b border-gray-100 dark:border-slate-400 dark:bg-gray-800">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="flex items-center justify-between gap-2 h-16">
          ...
          <div class="flex-1 flex items-center gap-3">
            <TextInput v-model="keywords" placeholder="Search on the website... , After search press enter" class="w-full" @keyup.enter="search"/>
          ...
          <div class="hidden sm:flex sm:items-center">
            ...
            <div class="ms-3 relative">
              ...
              <div v-else>
                <Link :href="route('login')" class="dark:text-slate-300">Login</Link>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
          ...
          <template v-else>
            <Link :href="route('login')" class="ml-2 dark:text-slate-300">Login</Link>
          </template>
        </div>
      </div>
    </nav>
